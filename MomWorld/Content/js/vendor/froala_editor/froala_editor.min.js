...
! function(a) {
    ...
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "DIV", "LI", "TD", "TH"], b.LANGS = [], b.DEFAULTS = {
        ...
        for (var d = a("<div>").append(b).find("*"), e = 0; e < d.length; e++)
            if (this.valid_nodes.indexOf(d[e].tagName) >= 0) return this.breakHTML(b), !1;
...
function(a) {
    ...
    a.Editable.DEFAULTS = a.extend(a.Editable.DEFAULTS, {
        ...
        for (var p = 0; p < b.length; p++)
            if (d = b.charAt(p), "<" == d) {
                ...
                if (-1 !== q) {
                    ...
                    var x = null;
                    if (r)
                        for (var y = 0; y < r.length; y++) 0 === r[y].indexOf("class=") && (x = r[y]), 0 === r[y].indexOf("style=") && r.splice(y, 1);
        ...
        for (b = "", e = 0; e <= k.length; e++) {
            ...
            if (j[e])
                for (j[e] = j[e].sort(this.sortSimpleTags), g = 0; g < j[e].length; g++) b += j[e][g].content;
            e != k.length && (b += k[e])
        }
        return b
