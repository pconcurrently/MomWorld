$(function() {
    ...
    var k = $("#latest-projects .owl-carousel");
    k.owlCarousel({
        items: 3,
        itemsDesktop: false,
        pagination: false
    ...
    $(".twitter-feed").tweet({
        username: "envato",
        modpath: "assets/js/vendor/tweet-js/jquery.tweet.min.js",
        join_text: "",
        avatar_size: null,
        count: 10,
    ...
    var d = $("#our-clients .owl-carousel");
    d.owlCarousel({
        items: 4,
        pagination: false
    });
    ...
    var q = $("#clients-feedback .owl-carousel");
    q.owlCarousel({
        singleItem: true,
        pagination: false
    });
    ...
    var u = function() {
        ! function(z, v, A) {
            var y, w = z.getElementsByTagName(v)[0],
                x = /^http:/.test(z.location) ? "http" : "https";
            if (!z.getElementById(A)) {
                y = z.createElement(v);
                y.id = A;
                y.src = x + "://platform.twitter.com/widgets.js";
    ...
    $(".appear-el").each(function() {
        $(this).appear(function() {
            var s = $(this).data("animation");
            $(this).delay(150).queue(function(v) {
    ...
    $(".navbar .dropdown").not("a").click(function(s) {
        if ($(s.target).hasClass("dropdown-toggle")) {
            if ($(this).attr("data-init") == "onHover") {
                return false;
            }
        }
