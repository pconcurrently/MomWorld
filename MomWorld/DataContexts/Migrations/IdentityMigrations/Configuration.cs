namespace MomWorld.DataContexts.Migrations.IdentityMigrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MomWorld.DataContexts.IdentityDb>
    {
        ...
        protected override void Seed(MomWorld.DataContexts.IdentityDb context)
        {
            ...
            {
                var user1 = new ApplicationUser { Email = "phohtse90083@fpt.edu.vn", UserName = "phoht", ProfilePicture = "~/App/uploads/avatar/default.png", Status = 2 };
            ...
            {
                var user2 = new ApplicationUser { Email = "khoapcse90038@fpt.edu.vn", UserName = "khoapc", ProfilePicture = "~/App/uploads/avatar/default.png", Status = 2 };
            ...
            {
                var user3 = new ApplicationUser { Email = "khoahnse56@fpt.edu.vn", UserName = "khoahn", ProfilePicture = "~/App/uploads/avatar/default.png", Status = 2 };
            ...
            {
                var user4 = new ApplicationUser { Email = "datntse90012@fpt.edu.vn", UserName = "datnt", ProfilePicture = "~/App/uploads/avatar/default.png", Status = 2 };
            ...
            {
                var user5 = new ApplicationUser { Email = "trungnmse90088@fpt.edu.vn", UserName = "trungnm", ProfilePicture = "~/App/uploads/avatar/default.png", Status = 2 };
