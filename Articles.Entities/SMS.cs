...
namespace MomWorld.Entities
{
    public class SMS
    {
        ...
        //Open Port
        public SerialPort OpenPort(string p_strPortName, string p_uBaudRate, string p_uDataBits, string p_uReadTimeout, string p_uWriteTimeout)
        {
            ...
            try
            {
                ...
                port.BaudRate = Convert.ToInt32(p_uBaudRate);                   //9600
                port.DataBits = Convert.ToInt32(p_uDataBits);                   //8
                port.StopBits = StopBits.One;                  //1
                port.Parity = Parity.None;                     //None
                port.ReadTimeout = Convert.ToInt32(p_uReadTimeout);             //300
                port.WriteTimeout = Convert.ToInt32(p_uWriteTimeout);           //300
